...
<div class="py-3 d-flex flex-row align-items-center justify-content-between">
    <h1 class="h3 mb-0 text-gray-800">Tambah Pengadaan Aset Tanah</h1>
    <a href="{{route('superadmin.pengadaan_tanah.index')}}"><button class="btn btn-primary">Kembali</button></a>
</div>

<form method="POST" action="{{ route('superadmin.pengadaan_tanah.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_pengadaan_tanah" value="{{ old('kode_pengadaan_tanah', $nextKodePengadaanTanah) }}" class="form-control" id="kode_pengadaan_tanah" readonly>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_tanah" value="{{ old('kode_tanah', $nextKodeTanah) }}" class="form-control" id="kode_tanah" readonly>
                    </div>
                    <div class="form-group">
