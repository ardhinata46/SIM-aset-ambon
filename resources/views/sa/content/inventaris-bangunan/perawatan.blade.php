...
<div class="py-3 d-flex flex-row align-items-center justify-content-between">
    <h1 class="h3 mb-0 text-gray-800">Tambah Perawatan {{$bangunan->nama_bangunan}} </h1>
    <a href="{{route('superadmin.inventaris_bangunan.index')}}"><button class="btn btn-primary">Kembali</button></a>
</div>

<form method="POST" action="{{ route('superadmin.inventaris_bangunan.store_perawatan', $bangunan->id_bangunan) }}" enctype="multipart/form-data">
    @csrf
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="kode_perawatan_bangunan">Kode Perawatan Bangunan</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="id_bangunan" value="{{ $bangunan->kode_bangunan }} {{ $bangunan->nama_bangunan }}" class="form-control" id="id_bangunan" readonly>
                        @error('id_bangunan')
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline @error('kondisi_sesudah') is-invalid @enderror">
                            <div class="custom-control custom-radio mr-3">
                                <input type="radio" id="kondisi_baik" name="kondisi_sesudah" class="custom-control-input" value="baik" {{ old('kondisi_sesudah') == 'baik' ? 'checked' : '' }} required>
                                <label class="custom-control-label" for="kondisi_baik">Baik</label>
                            </div>
                            <div class="custom-control custom-radio mr-3">
                                <input type="radio" id="rusak_ringan" name="kondisi_sesudah" class="custom-control-input" value="rusak_ringan" {{ old('kondisi_sesudah') == 'rusak_ringan' ? 'checked' : '' }} required>
                                <label class="custom-control-label" for="rusak_ringan">Rusak Ringan</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="rusak_berat" name="kondisi_sesudah" class="custom-control-input" value="rusak_berat" {{ old('kondisi_sesudah') == 'rusak_berat' ? 'checked' : '' }} required>
