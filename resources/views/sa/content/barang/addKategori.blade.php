...
<div class="py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <a href="{{route('superadmin.barang.add')}}"><button class="btn btn-primary">Kembali</button></a>
</div>
<div class="row">
    <div class="col-lg-12">
        <!-- Form Basic -->
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="{{route ('superadmin.barang.storeKategori')}}" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="kode_kategori_barang">Kode Kategori Barang<span style="color: red">*</span></label>
