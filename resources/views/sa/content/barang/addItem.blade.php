...
<div class="py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <a href="{{route('superadmin.barang.detail', $barang->id_barang)}}"><button class="btn btn-primary">Kembali</button></a>
</div>

<form method="POST" action="{{ route('superadmin.barang.store_item_barang', $barang->id_barang) }}">
    @csrf
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="formatRupiah(this)" name="harga_perolehan" value="{{ old('harga_perolehan') }}" class="form-control @error('harga_perolehan') is-invalid @enderror" min="0" id="harga_perolehan" required>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="umur_manfaat" value="{{ old('umur_manfaat') }}" class="form-control @error('umur_manfaat') is-invalid @enderror" id="umur_manfaat" min="0" required>
                    </div>
                    @error('umur_manfaat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="formatRupiah(this)" name="nilai_residu" value="{{ old('nilai_residu') }}" min="0" class="form-control @error('nilai_residu') is-invalid @enderror" id="nilai_residu" required>
                    </div>
                    @error('nilai_residu')
                    <div class="invalid-feedback">
                        {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah" class="form-control" id="jumlah" required min="0">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline @error('kondisi') is-invalid @enderror">
                            ...
                            <div class="custom-control custom-radio mr-3">
                                <input type="radio" id="kondisi_rusak_ringan" name="kondisi" class="custom-control-input" value="rusak_ringan" {{ old('kondisi') == 'rusak_ringan' ? 'checked' : '' }} required>
                                <label class="custom-control-label" for="kondisi_rusak_ringan">Rusak Ringan</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="kondisi_rusak_berat" name="kondisi" class="custom-control-input" value="rusak_berat" {{ old('kondisi') == 'rusak_berat' ? 'checked' : '' }} required>
