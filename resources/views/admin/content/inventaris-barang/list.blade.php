                    ...
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.inventaris_barang.detail', $row->id_item_barang) }}" data-toggle="tooltip" data-placement="top" title="Detail Item Barang" class="btn btn-outline-info btn-sm">
                                        <i class="fas fa-info-circle"></i>
                                    </a>

                                    @if($row->status == 1)
                                    <a href="{{ route('admin.inventaris_barang.perawatan', $row->id_item_barang) }}" data-toggle="tooltip" data-placement="top" title="Perawatan Barang" class="btn btn-outline-warning btn-sm">
...
<div class="modal fade" id="inventarisBarangModal" tabindex="-1" role="dialog" aria-labelledby="inventarisBarangModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.inventaris_barang.filterInventarisBarangPDF') }}">
                @csrf
