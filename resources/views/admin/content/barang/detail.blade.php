...
<div class="card mb-3">
    <div class="card-body">
        <div class="d-sm-flex  mb-4 align-items-center justify-content-between">
            ...
            <a href="{{route('admin.barang.add_item_barang', $barang->id_barang)}}" class="btn btn-primary"><i class="fa fa-plus"></i> Item</a>
        </div>
            ...
            <table class="table" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.barang.detail_item_barang', $row->id_item_barang) }}" data-toggle="tooltip" data-placement="top" title="Detail Item Barang" class="btn btn-outline-info btn-sm">
                                <i class="fas fa-info-circle"></i>
                            </a>
                            <a href="{{ route('admin.barang.edit_item_barang', $row->id_item_barang) }}" data-toggle="tooltip" data-placement="top" title="Edit Item Barang" class="btn btn-outline-warning btn-sm">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('admin.barang.delete_item_barang', $row->id_item_barang) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
