                ...
                <div class="card-title">
                    <div class="d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.laporan.peminjamanExcel') }}" target="_blank" class="btn btn-sm btn-outline-success" title="Cetak Laporan Peminjaman Excel">
                                Export Excel <i class="fa fa-file-excel"></i>
                            </a>
                            <a href="{{ route('admin.laporan.peminjamanPDF') }}" target="_blank" class="btn btn-sm btn-outline-danger" title="Cetak Laporan Peminjaman PDF">
                ...
                <div class="card-title">
                    <div class="d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.laporan.belumKembaliExcel') }}" target="_blank" class="btn btn-sm btn-outline-success" title="Cetak Laporan Barang Belum Dikembalikan Excel">
                                Export Excel <i class="fa fa-file-excel"></i>
                            </a>
                            <a href="{{ route('admin.laporan.belumKembaliPDF') }}" target="_blank" class="btn btn-sm btn-outline-danger" title="Cetak Laporan Pengembalian PDF">
                                Export PDF <i class="fa fa-file-pdf"></i>
                            </a>
                        </div>
...
<div class="modal fade" id="peminjamanModal" tabindex="-1" role="dialog" aria-labelledby="peminjamanModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.laporan.filterPeminjaman') }}" method="POST" target="_blank">
                @csrf
...
<div class="modal fade" id="belumKembaliModal" tabindex="-1" role="dialog" aria-labelledby="belumKembaliModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.laporan.filterBelumKembali') }}" method="POST" target="_blank">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
