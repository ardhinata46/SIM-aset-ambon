...
<div class="py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <a href="{{route('admin.pengadaan_barang.add')}}"><button class="btn btn-primary">Kembali</button></a>
</div>
<div class="row">
    <div class="col-lg-12">
        <!-- Form Basic -->
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="{{route ('admin.pengadaan_barang.store_barang')}}">
                    @csrf
