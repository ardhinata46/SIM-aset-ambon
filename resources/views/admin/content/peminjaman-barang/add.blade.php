...
<form method="POST" action="{{route ('admin.peminjaman_barang.store')}}">
    @csrf
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jaminan" value="{{ old('jaminan') }}" class="form-control @error('jaminan') is-invalid @enderror" id="jaminan" required>
                        @error('jaminan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
    ...
    <div class="row">
        <div class="col-lg-5">
            <div class="card mb-3">
                <div class="card-body">
                    <!-- <form id="formPilihItem" method="POST">
                        @csrf -->
...
<script>
    ...
    idItemBarangSelect.addEventListener('change', function() {
        ...
        if (existingItem) {
            ...
            alert('Item barang sudah ada di tabel peminjaman.');
        } else {
