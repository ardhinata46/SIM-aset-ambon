...
class PeminjamanBarangController extends Controller
{
    ...
    public function add()
    {
        ...
        return view('sa.content.peminjaman-barang.add', compact('title', 'nextKodePeminjamanBarang', 'itemBarang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect(route('superadmin.peminjaman_barang.index'))->with('success', 'Peminjaman barang berhasil ditambah!');
        } catch (\Exception $e) {
            DB::rollback();
            return redirect(route('superadmin.peminjaman_barang.index'))->with('error', 'Peminjaman barang gagal ditambah!');
        }
    }
    ...
    public function detail($id_peminjaman_barang)
    {
        ...
        return view('sa.content.peminjaman-barang.detail', compact('title', 'detail', 'items'));
    }
    ...
    public function edit($id_peminjaman_barang)
    {
        ...
        return view('sa.content.peminjaman-barang.edit', compact('peminjamanBarang', 'title'));
    }
    ...
    public function update(Request $request, $id_peminjaman_barang)
    {
        ...
        try {
            $peminjamanBarang->save();
            return redirect(route('superadmin.peminjaman_barang.index'))->with('success', 'Peminjaman barang berhasil diubah!');
        } catch (\Exception $e) {
            return redirect(route('superadmin.peminjaman_barang.index'))->with('error', 'Peminjaman barang gagal diubah!');
        }
    }

    public function delete($id_peminjaman_barang)
    {
        $peminjamanBarang = PeminjamanBarang::findOrFail($id_peminjaman_barang);

        // hapus item peminjaman barang
        $itemPeminjaman = ItemPeminjamanBarang::where('id_peminjaman_barang', $id_peminjaman_barang);
        $itemPeminjaman->delete();

        // hapus peminjaman
        try {
            $peminjamanBarang->delete();
            return redirect(route('superadmin.peminjaman_barang.index'))->with('success', 'Peminjaman barang berhasil dihapus!');
        } catch (\Exception $e) {
            return redirect(route('superadmin.peminjaman_barang.index'))->with('error', 'Peminjaman barang gagal dihapus!');
        }
    }
    ...
    public function pengembalian($id_peminjaman_barang)
    {
        ...
        return view('sa.content.peminjaman-barang.addPengembalian', compact('title', 'nextKodePengembalianBarang', 'peminjamanBarang', 'items'));
    }
    ...
    public function storePengembalian(Request $request, $id_peminjaman_barang)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect(route('superadmin.peminjaman_barang.index'))->with('success', 'Pengembalian barang berhasil ditambah!');
        } catch (\Exception $e) {
            DB::rollback();
            return redirect(route('superadmin.peminjaman_barang.index'))->with('error', 'Pengembalian barang gagal ditambah!');
        }
    }
