...
class BarangController extends Controller
{
    public function index()
    {
        ...
        return view('sa.content.barang.list', compact('title', 'barang', 'KategoriBarang'));
    }
    ...
    public function add()
    {
        ...
        return view('sa.content.barang.add', compact('title', 'kategoriBarang', 'nextKodeBarang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $barang->save();
            return redirect(route('superadmin.barang.index'))->with('success', 'Barang berhasil ditambah!');
        } catch (\Exception $e) {
            dd($e->getMessage());
            return redirect(route('superadmin.barang.index'))->with('error', 'Barang gagal ditambah!');
        }
    }
    ...
    public function edit($id_barang)
    {
        ...
        return view('sa.content.barang.edit', compact('title', 'kategoriBarang', 'barang'));
    }
    ...
    public function update(Request $request, $id_barang)
    {
        ...
        $barang->updated_by         = Auth::guard('superadmin')->user()->id_pengguna;
    ...
    public function delete($id_barang)
    {
        ...
        try {
            $barang->delete();
            return redirect(route('superadmin.barang.index'))->with('success', 'Barang berhasil dihapus!');
        } catch (\Exception $e) {
            return redirect(route('superadmin.barang.index'))->with('error', 'Barang gagal dihapus!');
        }
    }
    ...
    public function detail($id_barang)
    {
        ...
        return view('sa.content.barang.detail', compact('title', 'barang', 'itemBarang'));
    }
    ...
    public function addKategori()
    {
        ...
        return view('sa.content.barang.addKategori', compact('title', 'nextKodeKategoriBarang'));
    }
    ...
    public function storeKategori(Request $request)
    {
        ...
        try {
            $kategoriBarang->save();
            return redirect(route('superadmin.barang.add'))->with('success', 'Kategori berhasil ditambah!');
        } catch (\Exception $e) {
            return redirect(route('superadmin.barang.add'))->with('error', 'Kategori gagal ditambah!');
        }
    }
    ...
    public function addItem($id_barang)
    {
        ...
        return view('sa.content.barang.addItem', compact('title', 'barang'));
    }
    ...
    public function storeItem(Request $request, $id_barang)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect(route('superadmin.barang.detail', $id_barang))->with('success', 'Item barang berhasil ditambah!');
        } catch (\Exception $e) {
            DB::rollback();
            return redirect(route('superadmin.barang.detail', $id_barang))->with('error', 'Item barang gagal ditambah!');
        }
    }
    ...
    public function detailItem($id_item_barang)
    {
        ...
        return view('sa.content.barang.detailItem', compact('title', 'itemBarang', 'id_barang'));
    }
    ...
    public function editItem($id_item_barang)
    {
        ...
        $id_barang = $itemBarang->id_barang;
        return view('sa.content.barang.editItem', compact('title', 'itemBarang', 'id_barang', 'barang'));
    }
    ...
    public function updateItem(Request $request, $id_item_barang)
    {
        ...
        $itemBarang->updated_by             = Auth::guard('superadmin')->user()->id_pengguna;

        try {
            $itemBarang->save();
            return redirect(route('superadmin.barang.detail', $id_barang))->with('success', 'Item barang berhasil diubah!');
        } catch (\Exception $e) {
            DB::rollback();
            dd($e->getMessage());
            return redirect(route('superadmin.barang.detail', $id_barang))->with('error', 'Item barang gagal diubah!');
        }
    }
    ...
    public function deleteItem($id_item_barang)
    {
        ...
        try {
            $itemBarang->delete();
            return redirect(route('superadmin.barang.detail', $id_barang))->with('success', 'Barang berhasil dihapus!');
        } catch (\Exception $e) {
            return redirect(route('superadmin.barang.detail', $id_barang))->with('error', 'Barang gagal dihapus!');
        }
    }
}
