...
class PerawatanBarangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sa.content.perawatan-barang.list', compact('title', 'perawatanBarang'));
    }
    ...
    public function add()
    {
        ...
        return view('sa.content.perawatan-barang.add', compact('title', 'nextKodePerawatanBarang', 'barang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect(route('superadmin.perawatan_barang.index'))->with('success', 'Perawatan barang berhasil ditambah!');
        } catch (\Exception $e) {
            DB::rollback();
            dd($e->getMessage());
            return redirect(route('superadmin.perawatan_barang.index'))->with('error', 'Perawatan barang gagal ditambah!');
        }
    }
    ...
    public function detail($id_perawatan_barang)
    {
        ...
        return view('sa.content.perawatan-barang.detail', compact('title', 'detail'));
    }
    ...
    public function edit($id_perawatan_barang)
    {
        ...
        return view('sa.content.perawatan-barang.edit', compact('title', 'barang', 'perawatanBarang'));
    }
    ...
    public function update(Request $request, $id_perawatan_barang)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect(route('superadmin.perawatan_barang.index'))->with('success', 'Perawatan barang berhasil diupdate!');
        } catch (\Exception $e) {

            return redirect(route('superadmin.perawatan_barang.index'))->with('error', 'Perawatan barang gagal diupdate!');
        }
    }

    public function delete($id_perawatan_barang)
    {
        $perawatanBarang = PerawatanBarang::findOrFail($id_perawatan_barang);
        ...
        try {
            ...
            $perawatanBarang = PerawatanBarang::findOrFail($id_perawatan_barang);
            $barang = $perawatanBarang->id_item_barang;
            $kembalikanKondisi = $perawatanBarang->kondisi_sebelum;
            $perawatanBarang->delete();

            $barang = ItemBarang::findOrFail($barang); // Mengambil data barang sebelumnya
            $barang->kondisi = $kembalikanKondisi;
            $barang->save();

            DB::commit();
            return redirect(route('superadmin.perawatan_barang.index'))->with('success', 'Perawatan barang berhasil dihapus!');
        } catch (\Exception $e) {
            DB::rollback();
            dd($e->getMessage());
            return redirect(route('superadmin.perawatan_barang.index'))->with('error', 'Perawatan barang gagal dihapus!');
        }
    }
}
