...
class PengadaanBarangController extends Controller
{
    public function index()
    {
        ...
        return view('admin.content.pengadaan-barang.list', compact('title', 'pengadaanBarang'));
    }
    ...
    public function addBarang()
    {
        ...
        return view('admin.content.pengadaan-barang.addBarang', compact('title', 'kategoriBarang', 'nextKodeBarang'));
    }
    ...
    public function storeBarang(Request $request)
    {
        ...
        try {
            $barang->save();
            return redirect(route('admin.pengadaan_barang.add'))->with('success', 'Barang berhasil ditambah!');
        } catch (\Exception $e) {

            return redirect(route('admin.pengadaan_barang.add'))->with('error', 'Barang gagal ditambah!');
        }
    }
    ...
    public function add()
    {
        ...
        return view('admin.content.pengadaan-barang.add', compact('title', 'nextKodePengadaanBarang', 'kategoriBarang', 'barang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $pengadaanBarang->created_by = Auth::guard('admin')->user()->id_pengguna;
            ...
            return redirect(route('admin.pengadaan_barang.index'))->with('success', 'Pengadaan barang berhasil ditambah!');
        } catch (\Exception $e) {
            DB::rollback();
            dd($e->getMessage());
            return redirect(route('admin.pengadaan_barang.index'))->with('error', 'Pengadaan barang gagal ditambah!');
        }
    }
    ...
    public function detail($id_pengadaan_barang)
    {
        ...
        $item = ItemPengadaanBarang::where('id_pengadaan_barang', $id_pengadaan_barang)->get();

        return view('admin.content.pengadaan-barang.detail', compact('title', 'detail', 'item'));
    }
    ...
    public function edit($id_pengadaan_barang)
    {
        ...
        return view('admin.content.pengadaan-barang.edit', compact('title', 'pengadaanBarang'));
    }
    ...
    public function update(Request $request, $id_pengadaan_barang)
    {
        ...
        $pengadaanBarang->updated_by = Auth::guard('admin')->user()->id_pengguna;
        ...
        try {
            $pengadaanBarang->save();
            return redirect(route('admin.pengadaan_barang.index'))->with('success', 'Pengadaan barang berhasil diubah!');
        } catch (\Exception $e) {
            return redirect(route('admin.pengadaan_barang.index'))->with('error', 'Pengadaan barang gagal diubah!');
        }
    }
}
