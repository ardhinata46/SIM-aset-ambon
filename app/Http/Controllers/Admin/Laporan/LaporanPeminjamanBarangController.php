...
class LaporanPeminjamanBarangController extends Controller
{
    public function peminjaman()
    {
        ...
        return view('admin.content.laporan.peminjaman', compact('title', 'peminjamanBarang', 'items', 'filter'));
    }
    ...
    public function belumKembaliPDF()
    {
        ...
        $pdf = Pdf::loadView('admin.content.laporan.peminjaman.belumKembaliCetak', $data);
    ...
    public function peminjamanPDF()
    {
        ...
        $peminjamanBarang = PeminjamanBarang::orderBy('peminjaman_barangs.id_peminjaman_barang', 'ASC')->get();
        ...
        $pdf = Pdf::loadView('admin.content.laporan.peminjaman.peminjamanBarangCetak', $data);
        $pdf->setPaper('legal', 'landscape');
        return $pdf->download($namaFile);
    }
